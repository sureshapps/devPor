window.onload = function () {
    var firework = FireWorksNS.Fireworks({
        id : 'fireworks-canvas',
        hue : 240,
        particleCount : 50,
        delay : 0,
...
var FireWorksNS = FireWorksNS || {};

FireWorksNS.Fireworks = function (options) {

    'use strict';

    if (!(this instanceof FireWorksNS.Fireworks)) {
        return new FireWorksNS.Fireworks(options);
    }
    ...
    _Class.settings = {
        ...
        particleGravity : options.particleGravity || 1.7
    };
 ...
 *
 */
FireWorksNS.Firework = function (x1, y1, x2, y2, context, hue) {

    'use strict';

    if (!(this instanceof FireWorksNS.Firework)) {
        return new FireWorksNS.Firework(x1, y1, x2, y2, context, hue);
    }
    ...
    var _self     = this,
        ...
        _Class    = _NS.Firework,
        _proto    = _Class.prototype,
        _settings = FireWorksNS.Fireworks.settings,
        _x   = x1,
        _y   = y1,
        _sx  = x1,
        _sy  = y1,
 ...
 *
 */
FireWorksNS.Particle = function (x, y, context, hue) {

    'use strict';

    if (!(this instanceof FireWorksNS.Particle)) {
        return new FireWorksNS.Particle(x, y, context, hue);
    }
 ...
 *
 */
FireWorksNS.randomRange = function (min, max) {
 ...
 *
 */
FireWorksNS.randomIntRange = function (min, max) {
    return FireWorksNS.randomRange(min, max)|0;
};

/**
 *
 */
FireWorksNS.distance = function (x1, y1, x2, y2) {
    var pow = Math.pow;
 ...
 *
 */
FireWorksNS.getRenderLoop = function () {
    return (
